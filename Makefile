...
all: armtest armv2.so boot.rom rijndael tapes/guessing.bin tapes/trivia.bin tapes/adventure.bin
...
tapes/adventure.bin: adventure tape_loader.bin
	python create_tape.py $@ $^
...
clean:
	rm -f armv2 os tapes/adventure.bin adventure tapes/trivia.bin trivia tapes/guessing.bin guessing boot.rom armtest step.o instructions.o init.o armv2.c armv2.so *~ libarmv2.a boot.bin boot.o mmu.o hw_manager.o *.pyc

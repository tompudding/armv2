...
pygame.mixer.init()
change = pygame.mixer.Sound(globals.pyinst.path("change.ogg"))
hurt = pygame.mixer.Sound(globals.pyinst.path("hurt.ogg"))
eat = pygame.mixer.Sound(globals.pyinst.path("eat.ogg"))
            ...
            with self.cv:
                while self.running:
                    while self.running and (
                        (self.steps_to_run == 0)
                        or (
                            self.status == armv2.Status.WaitForInterrupt
